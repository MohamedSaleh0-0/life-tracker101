...
import { ModalHost } from "@/components/app/modals";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Life Tracker — money, habits and metrics in one view" },
      {
        name: "description",
        content:
          "A dark personal analytics dashboard that tracks finances, habits and daily metrics side by side.",
      },
